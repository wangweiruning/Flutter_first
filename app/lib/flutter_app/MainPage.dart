...
import 'package:app/flutter_app/page/MsgPage.dart';
import 'package:app/flutter_app/page/HomePage.dart';
import 'package:app/flutter_app/page/ShopPage.dart';
import 'package:app/flutter_app/page/MyPage.dart';
import 'package:app/flutter_app/page/Demo1.dart';
import 'package:app/flutter_app/page/Goto.dart';
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          ...
          "/Goto": (BuildContext context) => new Goto(),
        },
...
class MainPageState extends State<MainPageWidget> {
  ...
  Text getTabTitle(int curIndex) {
    if (curIndex == _tabIndex) {
      ...
      return new Text(appBarTitles[curIndex],
          style: new TextStyle(color: const Color(0xffcdcdcd)));
    }
  }
  /*
   * 存储的四个页面，和Fragment一样
